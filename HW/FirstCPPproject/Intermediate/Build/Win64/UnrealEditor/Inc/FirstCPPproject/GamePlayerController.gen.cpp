...
#include "FirstCPPproject/Public/GamePlayerController.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeGamePlayerController() {}
// Cross Module References
	FIRSTCPPPROJECT_API UClass* Z_Construct_UClass_AGamePlayerController_NoRegister();
	FIRSTCPPPROJECT_API UClass* Z_Construct_UClass_AGamePlayerController();
...
// End Cross Module References
	...
	template<> FIRSTCPPPROJECT_API UClass* StaticClass<AGamePlayerController>()
	{
		return AGamePlayerController::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AGamePlayerController);
	struct Z_CompiledInDeferFile_FID_FirstCPPproject_Source_FirstCPPproject_Public_GamePlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FirstCPPproject_Source_FirstCPPproject_Public_GamePlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGamePlayerController, AGamePlayerController::StaticClass, TEXT("AGamePlayerController"), &Z_Registration_Info_UClass_AGamePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGamePlayerController), 3918462664U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FirstCPPproject_Source_FirstCPPproject_Public_GamePlayerController_h_3810021180(TEXT("/Script/FirstCPPproject"),
		Z_CompiledInDeferFile_FID_FirstCPPproject_Source_FirstCPPproject_Public_GamePlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FirstCPPproject_Source_FirstCPPproject_Public_GamePlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
