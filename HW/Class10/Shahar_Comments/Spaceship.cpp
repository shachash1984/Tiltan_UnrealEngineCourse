...
Spaceship::Spaceship(const Spaceship& other) : name(other.name), weapons(other.weapons) // I am checking this assignment as HW 9, I said that HW 10 needs to submitted separately
{
	if (!weapons.empty())
	{
		currentWeapon = weapons[0];
