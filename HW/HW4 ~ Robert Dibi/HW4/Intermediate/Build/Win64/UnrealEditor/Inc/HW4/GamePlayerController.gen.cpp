...
// Cross Module References
	HW4_API UClass* Z_Construct_UClass_AGamePlayerController_NoRegister();
	HW4_API UClass* Z_Construct_UClass_AGamePlayerController();
...
// End Cross Module References
	...
	template<> HW4_API UClass* StaticClass<AGamePlayerController>()
	{
		return AGamePlayerController::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AGamePlayerController);
	struct Z_CompiledInDeferFile_FID_HW4_Source_HW4_Public_GamePlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HW4_Source_HW4_Public_GamePlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGamePlayerController, AGamePlayerController::StaticClass, TEXT("AGamePlayerController"), &Z_Registration_Info_UClass_AGamePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGamePlayerController), 1192855449U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HW4_Source_HW4_Public_GamePlayerController_h_3570370867(TEXT("/Script/HW4"),
		Z_CompiledInDeferFile_FID_HW4_Source_HW4_Public_GamePlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HW4_Source_HW4_Public_GamePlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
