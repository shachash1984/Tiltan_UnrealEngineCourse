...
#define UE_PROJECT_NAME TiltanPhysics
#define UE_TARGET_NAME TiltanPhysicsEditor
#define UE_MODULE_NAME "TiltanPhysics"
...
#define TILTANPHYSICS_API DLLEXPORT
