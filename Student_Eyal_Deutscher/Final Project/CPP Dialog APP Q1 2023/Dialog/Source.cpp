...
int main()
{
	...
	for (unsigned int i = 0; i < parser.GetData().size(); i++)
	{
		...
		dialogBox.RegisterElementToOnRender(make_shared<DialogElementTitle>(dialogTitle));
		//Text
		...
		dialogBox.RegisterElementToOnRender(make_shared<DialogElementText>(dialogText));
		//---points---
		...
		dialogBox.RegisterElementToOnCreate(make_shared<DialogElementPosition>(dialogPosition));
		//size
		...
		dialogBox.RegisterElementToOnCreate(make_shared<DialogElementSize>(dialogSize));
		//---Colors---
		...
		dialogBox.RegisterElementToOnCreate(make_shared<DialogElementWindowColor>(dialogColor));
		//text Color
		...
		dialogBox.RegisterElementToOnCreate(make_shared<DialogElementTextColor>(dialogColor));
		//---Buttons---
		...
		for (unsigned int i = 0; i < dialogButtons.size(); i++)
		{
			...
			dialogBox.RegisterElementToOnButton(make_shared<DialogElementButton>(dialogButton));
		}
