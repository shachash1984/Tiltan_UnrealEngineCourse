...
#include "WorkInClass/Public/Arrow.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeArrow() {}
// Cross Module References
	WORKINCLASS_API UClass* Z_Construct_UClass_AArrow_NoRegister();
	WORKINCLASS_API UClass* Z_Construct_UClass_AArrow();
...
// End Cross Module References
	...
	template<> WORKINCLASS_API UClass* StaticClass<AArrow>()
	{
		return AArrow::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AArrow);
	struct Z_CompiledInDeferFile_FID_WorkInClass_Source_WorkInClass_Public_Arrow_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_WorkInClass_Source_WorkInClass_Public_Arrow_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AArrow, AArrow::StaticClass, TEXT("AArrow"), &Z_Registration_Info_UClass_AArrow, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AArrow), 217425986U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_WorkInClass_Source_WorkInClass_Public_Arrow_h_2577925139(TEXT("/Script/WorkInClass"),
		Z_CompiledInDeferFile_FID_WorkInClass_Source_WorkInClass_Public_Arrow_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_WorkInClass_Source_WorkInClass_Public_Arrow_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
