...
struct Point {
	float x, y, z;
public: // -5 need to initialize in the ctor initializer list
	Point() {
		x = 0;
		y = 0;
		z = 0;
...
int main() { // -10 should be separated into multiple files
	//Stack
	Point point;
	Color color;
	Vertex vertex;
	...
	cout << p2->ToString() << endl; // -20 doesnt print anything
