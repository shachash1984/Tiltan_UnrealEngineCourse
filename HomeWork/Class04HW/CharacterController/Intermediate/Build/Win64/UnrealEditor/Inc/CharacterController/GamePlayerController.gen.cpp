...
#include "CharacterController/Public/GamePlayerController.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeGamePlayerController() {}
// Cross Module References
	CHARACTERCONTROLLER_API UClass* Z_Construct_UClass_AGamePlayerController_NoRegister();
	CHARACTERCONTROLLER_API UClass* Z_Construct_UClass_AGamePlayerController();
...
// End Cross Module References
	...
	template<> CHARACTERCONTROLLER_API UClass* StaticClass<AGamePlayerController>()
	{
		return AGamePlayerController::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AGamePlayerController);
	struct Z_CompiledInDeferFile_FID_CharacterController_Source_CharacterController_Public_GamePlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CharacterController_Source_CharacterController_Public_GamePlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGamePlayerController, AGamePlayerController::StaticClass, TEXT("AGamePlayerController"), &Z_Registration_Info_UClass_AGamePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGamePlayerController), 2133091247U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CharacterController_Source_CharacterController_Public_GamePlayerController_h_2297299665(TEXT("/Script/CharacterController"),
		Z_CompiledInDeferFile_FID_CharacterController_Source_CharacterController_Public_GamePlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CharacterController_Source_CharacterController_Public_GamePlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
